    ...
    <div className="w-full text-left">
      ...
      <p>
        ...
        <Button
          ...
          to={
            canUseBarcodes
              ? "/static/assetflow.app-example-asset-import-from-content-with-barcodes.csv"
              : "/static/assetflow.app-example-asset-import-from-content.csv"
          }
          target="_blank"
          download
        >
