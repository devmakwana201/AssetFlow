...
const baseCheckoutParams = {
  priceId: "price_123",
  userId: "user_1",
  domainUrl: "https://app.assetflow.app",
  customerId: "cus_123",
...
describe("createBarcodeAddonCheckoutSession", () => {
  it("creates checkout session with correct params and returns URL", async () => {
    ...
    expect(mockStripe.checkout.sessions.create).toHaveBeenCalledWith({
      ...
      success_url: "https://app.assetflow.app/assets?success=true&addon=barcodes",
      cancel_url: "https://app.assetflow.app/assets?canceled=true&addon=barcodes",
