  ...
  try {
    ...
    if (recipients.length > 0) {
      ...
      await sendBookingEmailToAllRecipients({
        recipients,
        booking: bookingFound,
        subject: `✅ Booking reserved (${bookingFound.name}) - assetflow.app`,
        textContent: text,
  ...
  try {
    ...
    if (recipients.length > 0) {
      ...
      await sendBookingEmailToAllRecipients({
        recipients,
        booking: updatedBooking,
        subject: `🎉 Booking complete (${updatedBooking.name}) - assetflow.app`,
        textContent: text,
  ...
  try {
    ...
    if (recipients.length > 0) {
      ...
      await sendBookingEmailToAllRecipients({
        recipients,
        booking,
        subject: `❌ Booking cancelled (${booking.name}) - assetflow.app`,
        textContent: text,
  ...
  try {
    ...
    if (recipients.length > 0) {
      ...
      await sendBookingEmailToAllRecipients({
        recipients,
        booking: updatedBooking,
        subject: `Booking extended (${updatedBooking.name}) - assetflow.app`,
        textContent: text,
...
export async function removeAssets({
  ...
  try {
    ...
    await db.$transaction(async (tx) => {
       ...
       *
       * See https://github.com/AssetFlow/assetflow.app/issues/703#issuecomment-1944315975
  ...
  try {
    ...
    if (recipients.length > 0) {
      ...
      await sendBookingEmailToAllRecipients({
        recipients,
        booking: b,
        subject: `🗑️ Booking deleted (${b.name}) - assetflow.app`,
        textContent: text,
    ...
    for (const b of bookings) {
      ...
      if (recipients.length > 0) {
        ...
        await sendBookingEmailToAllRecipients({
          recipients,
          booking: b,
          subject: `❌ Booking cancelled (${b.name}) - assetflow.app`,
          textContent: text,
