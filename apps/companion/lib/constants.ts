 ...
 *
 * All asset + booking status strings come from the shared `@assetflow/labels`
 ...
 * NOT the raw enum. Labels come from the shared `@assetflow/labels` package.
 *
