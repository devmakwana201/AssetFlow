 ...
 * `path` argument is the RAW FULL URL (`https://app.assetflow.app/assets/:id/overview`,
 ...
 * - `https://app.assetflow.app/assets/:id/overview` → host dropped → ["assets", ":id", "overview"]
