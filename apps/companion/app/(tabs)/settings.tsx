    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        <View style={styles.card}>
          <TouchableOpacity
            ...
            onPress={() =>
              WebBrowser.openBrowserAsync("https://assetflow.app")
            }
            activeOpacity={0.7}
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              Alert.alert(
                "Delete Account",
                "Account deletion is handled through the Shelf web app. You will be redirected to assetflow.app to complete this process.",
                [
                  { text: "Cancel", style: "cancel" },
                  {
                    text: "Continue",
                    ...
                    onPress: () =>
                      WebBrowser.openBrowserAsync(
                        "https://app.assetflow.app/settings/general"
                      ),
                  },
                ]
              );
      ...
      <Text style={styles.companionFooter}>
        ...
        <Text
          ...
          onPress={() => WebBrowser.openBrowserAsync("https://app.assetflow.app")}
        >
          app.assetflow.app
        </Text>
      </Text>
