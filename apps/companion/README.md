...
A native iOS/Android companion app for [AssetFlow](https://assetflow.app) built with **Expo SDK 54 + React Native + TypeScript**. It gives field teams mobile access to assets, scanning, audits, and bookings — all powered by the existing Shelf webapp backend.
...
- `@assetflow/database` Prisma types are immediately available
