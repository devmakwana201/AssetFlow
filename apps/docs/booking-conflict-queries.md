...
This document provides comprehensive documentation for all booking conflict detection patterns used throughout the AssetFlow codebase. Understanding these patterns is crucial for maintaining consistency when modifying booking-related functionality.

## Overview

AssetFlow uses three distinct patterns for handling booking conflicts and asset availability:
