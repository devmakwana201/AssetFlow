...
| Relay State | `https://app.assetflow.app/oauthcallback`                                 |
...
It's very important to send this information to your support contact at Shelf to complete the SSO setup process. If you're not sure where to send this file, you can always reach us at [hello@assetflow.app](mailto:hello@assetflow.app).
