...
This document contains information about all PostgreSQL triggers used in AssetFlow. Triggers are database-level functions that automatically execute in response to certain events (like INSERT, UPDATE, DELETE) on specific tables.
...
**Migration File**: [`20250617074555_create_trigger_that_create_user_contact_on_insert_in_user_table`](https://github.com/AssetFlow/assetflow.app/tree/main/packages/database/prisma/migrations/20250617074555_create_trigger_that_create_user_contact_on_insert_in_user_table/migration.sql)
